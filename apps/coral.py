...
def main():
    ...
    sim_parser.add_argument("--test", "-t", type=int, default=1,
    ...
    if args.command == "clean":
        logger.info(f"Cleaning basic Verilog testbench for {args.top}")
        pyverilog_helpers.cleanup_pyverilog_artifacts()

    if args.command == "sim":
        logger.info("running simulation...")
        sim.run_simulation(simulator="icarus", wtb_module="test_top", src_dir="", rtl_sources=args.src, top_module=args.top, test_dir=None, output_dir=None)
